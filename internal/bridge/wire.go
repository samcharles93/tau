...
var EventTypes = []EventTypeInfo{
	...
	{"ChildTranscriptLoadedEvent", reflect.TypeFor[tauchat.ChildTranscriptLoadedEvent]()},
...
var CommandTypes = []CommandTypeInfo{
	...
	{"LoadChildTranscriptCommand", reflect.TypeFor[tauchat.LoadChildTranscriptCommand]()},
