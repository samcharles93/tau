...
func Run(
	...
	m := newModel(ctx, runtime, chatSub, sessionID, modelName, provider, availableModels, refresh, checkUpdate, showReasoning, reasoningEffort, toolCallsDefaultCollapsed, tracker, webURL, debug)
