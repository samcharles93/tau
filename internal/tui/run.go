...
func Run(ctx context.Context, runtime tauchat.ChatRuntime, cfg TUIConfig) error {
	if cfg.NewTUI {
		return tui2.Run(ctx, runtime, cfg.Bus, cfg.OnReady, cfg.SessionID, cfg.ModelName, cfg.Provider, cfg.MetricsConfig, cfg.AvailableModels, cfg.RefreshModels, cfg.ShowReasoning, cfg.ReasoningEffort, cfg.WebURL, cfg.Debug)
	}
