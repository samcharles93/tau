---
description: Source module internal/webui/src/components/ui/button/index.ts (35 lines).
resource: internal/webui/src/components/ui/button/index.ts
tags:
    - ts
    - source
...
**Path**: `internal/webui/src/components/ui/button/index.ts`  
**Lines**: 35
