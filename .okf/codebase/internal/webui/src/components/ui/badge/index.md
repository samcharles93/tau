---
description: Source module internal/webui/src/components/ui/badge/index.ts (24 lines).
resource: internal/webui/src/components/ui/badge/index.ts
tags:
    - ts
    - source
...
**Path**: `internal/webui/src/components/ui/badge/index.ts`  
**Lines**: 24
